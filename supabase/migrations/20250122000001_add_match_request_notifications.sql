-- Add match request notification functionality
-- When a match is created (status='pending'), notify the team2 owner
...
-- First, update notification types to include match_request
...
BEGIN
  -- Only send notification when status changes from pending to accepted/rejected
