...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    final result = await showDialog<bool>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content:
              Text(LocalizationService().translate('leave_team_confirmation')),
          actions: [
            TextButton(
    ...
    return BaseCard(
      ...
      child: Row(
        children: [
          ...
          SizedBox(
              width: ResponsiveConstants.getResponsiveSpacing(context, 'sm2')),
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                    height: ResponsiveConstants.getResponsiveSpacing(
                            context, 'xs') *
                        0.5),
                Text(value,
                    style: ResponsiveTextUtils.getScaledTextStyle(
    ...
    return BaseCard(
      ...
      child: Row(
        children: [
          ...
          SizedBox(
              width: ResponsiveConstants.getResponsiveSpacing(context, 'md')),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
  ...
  Widget build(BuildContext context) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: context.responsiveSpacing('lg')),
            const Text('Loading...')
          ],
        ),
      );
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              ...
              action:
                  SnackBarAction(label: 'Refresh', onPressed: _loadUserData),
            ),
          );
        }
      });
    ...
    if (_currentUser == null) {
      return Center(
          child:
              Text(LocalizationService().translate('no_user_data_available')));
    }
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: [
              ...
              context.colors.surface.withValues(alpha: 0.02)
            ],
            ...
            children: [
              Container(
                margin: EdgeInsets.symmetric(
                  horizontal:
                      ResponsiveConstants.getResponsiveSpacing(context, 'md'),
                  vertical:
                      ResponsiveConstants.getResponsiveSpacing(context, 'md'),
                ),
                child: BaseCard(
                  padding:
                      ResponsiveConstants.getResponsivePadding(context, 'lg'),
                  backgroundColor: context.colors.surface,
                  child: Column(
                    children: [
                      Container(
                      ...
                      if (user.position != null &&
                        ...
                        Container(
                          padding: EdgeInsets.symmetric(
                            horizontal:
                                ResponsiveConstants.getResponsiveSpacing(
                                    context, 'md'),
                            vertical: ResponsiveConstants.getResponsiveSpacing(
                                context, 'xs'),
                          ),
                          decoration: BoxDecoration(
                              color:
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          SizedBox(
                              width: ResponsiveConstants.getResponsiveSpacing(
                                  context, 'sm')),
                          Text(LocalizationService().translate('account_info'),
                      ...
                      if (user.position != null &&
                        ...
                        SizedBox(
                            height: ResponsiveConstants.getResponsiveSpacing(
                                context, 'xs2')),
                        _buildEnhancedInfoRow(
                            LocalizationService().translate('position'),
                            user.position!,
                            Icons.sports_soccer),
                      ],
                      if (user.skillLevel != null &&
                        ...
                        SizedBox(
                            height: ResponsiveConstants.getResponsiveSpacing(
                                context, 'xs2')),
                        _buildEnhancedInfoRow(
                            LocalizationService().translate('skill_level'),
                            _getSkillLevelTranslation(user.skillLevel!),
                            Icons.star),
                      ],
                      if (user.bio != null && user.bio!.isNotEmpty) ...[
                        SizedBox(
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(
                              width: ResponsiveConstants.getResponsiveSpacing(
                                  context, 'sm')),
                          Text(LocalizationService().translate('user_stats'),
                              style: AppTextStyles.cardTitle.copyWith(
                                  fontWeight: FontWeight.bold,
                                  color: context.colors.textPrimary)),
                        ],
                            ...
                            children: [
                              ...
                              SizedBox(
                                  width:
                                      ResponsiveConstants.getResponsiveSpacing(
                                          context, 'sm')),
                              Text(LocalizationService().translate('my_teams'),
                                  style: AppTextStyles.cardTitle.copyWith(
                                      fontWeight: FontWeight.bold,
                                      color: context.colors.textPrimary)),
                            ],
                          ...
                          child: TextButton.icon(
                            ...
                            label: Text(
                                LocalizationService()
                                    .translate('view_all_teams'),
                                style:
                                    ResponsiveTextUtils.getResponsiveTextStyle(
                                        context, 'bodySmall')),
                            style: TextButton.styleFrom(
                                foregroundColor:
                                    Theme.of(context).colorScheme.primary),
                      ...
                      if (teamProvider.userTeams.isEmpty)
                        EnhancedEmptyState(
                          ...
                          message: LocalizationService()
                              .translate('create_first_team_message'),
                            ...
                            return Container(
                              ...
                              child: ListTile(
                                ...
                                trailing: IconButton(
                                  ...
                                  onPressed: isOwner
                                      ? () =>
                                          context.go('/teams/${team.id}/manage')
              ...
              SizedBox(
                  height:
                      ResponsiveConstants.getResponsiveSpacing(context, 'lg')),
              Container(
                constraints: BoxConstraints(
                    maxWidth: context.isMobile ? double.infinity : 400),
                height: context.buttonHeight,
                child: PrimaryButton(
                    text: LocalizationService().translate('edit_profile'),
              ...
              if (user.isAdmin) ...[
                Container(
                  ...
                  child: SecondaryButton(
                      text: LocalizationService().translate('admin_dashboard'),
