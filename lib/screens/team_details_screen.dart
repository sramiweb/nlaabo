...
class _TeamDetailsScreenState extends State<TeamDetailsScreen> {
                    ...
                    children: [
                      ...
                      Card(
                        ...
                        shape: RoundedRectangleBorder(
                          ...
                          side: BorderSide(
                            color: (_team!.isRecruiting ? Colors.green : Colors.grey).withValues(alpha: 0.3),
                            width: 1.5,
                          ),
                        ),
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Container(
                                    ...
                                    child: _team!.logo != null && _team!.logo!.isNotEmpty
                                        ? ClipRRect(
                                            borderRadius: BorderRadius.circular(12),
                                            child: CachedImage(
                                              imageUrl: _team!.logo!,
                                              ...
                                              height: 60,
                                              fit: BoxFit.cover,
                                              errorWidget: const Icon(Icons.groups, color: Colors.white, size: 30),
                                            ),
                                          )
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: (_team!.isRecruiting ? Colors.green : Colors.grey).withValues(alpha: 0.15),
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              color: _team!.isRecruiting ? Colors.green : Colors.grey,
                                              fontSize: 12,
                              ...
                              _buildInfoRow(context, Icons.location_on, Colors.red.shade400, LocalizationService().translate('location'), _team!.location ?? LocalizationService().translate('not_specified')),
                              const SizedBox(height: 8),
                              _buildInfoRow(context, Icons.calendar_today, Colors.blue.shade400, LocalizationService().translate('created'), _formatDate(_team!.createdAt)),
                              const SizedBox(height: 8),
                              _buildInfoRow(context, Icons.group, Colors.green.shade400, LocalizationService().translate('members'), '${_members.length}/${_team!.maxPlayers}'),
                            ],
                          ),
                        ),
                      ),
                      ...
                      // Action Button
                      if (!isOwner && !isMember && !hasPendingRequest && _team!.isRecruiting)
                        SizedBox(
                          ...
                          child: ElevatedButton(
                            ...
                            child: _isJoining
                                ...
                                : Text(LocalizationService().translate('join_team')),
                          ),
                        )
                        ...
                        SizedBox(
                          ...
                          height: 50,
                          child: ElevatedButton(
                            onPressed: _isCancellingRequest ? null : _cancelJoinRequest,
                            style: ElevatedButton.styleFrom(
                            ...
                            child: _isCancellingRequest
                                ...
                                : Text(LocalizationService().translate('cancel_request')),
                          ),
                        )
                          ...
                          child: _members.isEmpty
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    final isCurrentUser = member.id == authProvider.user?.id;
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            gradient: LinearGradient(
                                              colors: [
                                                member.role == 'admin' ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.secondary,
                                                (member.role == 'admin' ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.secondary).withValues(alpha: 0.7),
                                              ],
                                            ),
                                            shape: BoxShape.circle,
                                            boxShadow: [
                                              BoxShadow(
                                                color: (member.role == 'admin' ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.secondary).withValues(alpha: 0.3),
                                                blurRadius: 6,
                                                offset: const Offset(0, 2),
                                              ),
                                            ],
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  Expanded(
                                                    child: Text(
                                                      member.name ?? LocalizationService().translate('unknown_user'),
                                                  ...
                                                  if (member.role == 'admin')
                                                    Container(
                                                      margin: EdgeInsetsDirectional.only(start: isCurrentUser ? 4 : 0),
                                                      padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2),
                                                      decoration: BoxDecoration(
                                                        color: Theme.of(context).colorScheme.primary,
                                                        borderRadius: BorderRadius.circular(6),
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                user?.name ?? LocalizationService().translate('unknown_user'),
                                      ...
                                      children: [
                                        Expanded(
                                          child: OutlinedButton(
                                            ...
                                            child: Text(LocalizationService().translate('reject'), style: const TextStyle(color: Colors.red)),
                                          ),
                                        ),
                                        const SizedBox(width: 12),
                                        Expanded(
                                          child: ElevatedButton(
                                            ...
                                            child: Text(LocalizationService().translate('accept')),
                                          ),
                                        ),
                                      ],
                                    ),
  ...
  Future<void> _acceptJoinRequest(String requestId) async {
    try {
      debugPrint('🔵 Accepting join request: $requestId for team: ${widget.teamId}');
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(LocalizationService().translate('request_approved'))));
      }
    } catch (e) {
  ...
  Future<void> _rejectJoinRequest(String requestId) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(LocalizationService().translate('request_rejected'))));
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(
  ...
  Widget _buildInfoRow(BuildContext context, IconData icon, Color color, String label, String value) {
    return Row(
      children: [
        Container(
