...
/// PrimaryButton component following the design system specifications
/// - Background: AppColors.primary (Lime Green)
/// - Text: White
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    if (_hoverAnimation.value > 0)
                      BoxShadow(
                        color: context.colors.primary.withValues(alpha: 0.3 * _hoverAnimation.value),
                        blurRadius: 8.0,
