...
/// SecondaryButton component following the design system specifications
/// - Background: Transparent with outline
/// - Border: context.colors.primary (Lime Green)
/// - Text: context.colors.primary
/// - Padding: 16px vertical, 24px horizontal
/// - Border radius: 12px
/// - Font: Inter, 16px, FontWeight.w600
/// - Hover: Background fill with primary color, scale 1.02
/// - Disabled: 50% opacity
